...
## 2017 Car crash data in Allegheny County {.smaller}

This Application uses data about car's accidents in Allegheny County in
the US, To demonstrate various capabilities from the Developing Data
Products Course. The Application provides visualization about car
accidents in Allegheny County in 2017.
...
-   Shiny Applicatio Link :
    <https://aishaalnaqbi.shinyapps.io/ShinyAssignment/>
-   Github Repository Link :
    <https://github.com/AishaAlnaqbi9/ShinyCourseProject>
...
-   Fatal And INJURY - Will be used to classifying the type of the
    accident And create different Icons.

## Data and Server calculations {.smaller}
...
-   Check the Min and Max cars number involved and pass it to the slider
    input.
-   Slice the dataset dynamically based on Month selection and the
    number of cars selection.

## Data and Server calculation (Cont.) {.smaller}
